...
inst_5 = Institution.new(name: "University of Basel", city: "Basel", country: "Switzerland", ranking: 37, user: admin )
...
inst_12 = Institution.new(name: "LSE - The London School", city: "London", country: "England", ranking: 6, user: admin )
...
inst_13 = Institution.new(name: "Henley School", city: "Henley-on-Thames", country: "England", ranking: 100, user: admin )
...
inst_14 = Institution.new(name: "University of Cambridge", city: "Cambridge", country: "England", ranking: 2, user: admin )
inst_14.remote_photo_url = url_14
inst_14.save

url_15 = "https://res.cloudinary.com/veronicabraga/image/upload/v1568223819/institutions/Aston_University_Lake_itmor1.jpg"
inst_15 = Institution.new(name: "Aston University", city: "Birmingham", country: "England", ranking: 174, user: admin )
...
inst_16 = Institution.new(name: "Defap- Graduate School", city: "Milano", country: "Italy", ranking: 401, user: admin )
